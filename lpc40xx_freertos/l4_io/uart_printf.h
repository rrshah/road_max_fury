 ...
 * internally uses sprintf() to print on a fixed buffer before printing the
 * stream to the UART
 */
 ...
 * This is helpful during debugging if you want to make sure your data is
 * printed entirely before this function exits
 */
