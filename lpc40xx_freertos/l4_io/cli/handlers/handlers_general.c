...
static void cli__task_list_print(sl_string_t user_input_minus_command_name,
...
static void cli__task_list_print(sl_string_t output_string,
                                 app_cli__print_string_function cli_output) {
...
app_cli_status_e cli__task_list(app_cli__argument_t argument,
                                sl_string_t user_input_minus_command_name,
                                app_cli__print_string_function cli_output) {
  cli_output(argument, "ERROR: configUSE_TRACE_FACILITY needs to be enabled at "
                       "FreeRTOSConfig.h\n");
  return APP_CLI_STATUS__SUCCESS;
}
