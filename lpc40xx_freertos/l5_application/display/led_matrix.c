...
static uint8_t *led_matrix_buffer[64];
// // static uint8_t row_to_display = 15;

// uint8_t **led_matrix__getBuffer(void) {
//   return (uint8_t **)led_matrix_buffer; 
// }
...
// static void led_matrix__updateDisplay_isr(void) {
...
// static void led_matrix__refresh_timer_init(void) {
